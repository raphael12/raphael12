...
<tr>
  ...
  <td>Лучший результат на кросс-валидации показала модель CatBoost со значение метрики MAE = 6.213 на тестовой выборки</td>
</tr>
<tr>
  ...
  <td> Использована и обучена модель линейной регрессии. Уже на стадии модели видно, что второй регион сильно выделяется на фоне других и являетс самым перспективным </td>
</tr>
<tr>
  ...
  <td>Лучше всего себя показала модель Gradient Boosting Regressor, с ошибкой метрики sMAPE = 8.67 </td>
</tr>
</table>
</details>
